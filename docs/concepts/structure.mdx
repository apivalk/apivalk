...
Even in PHP 7.4, Apivalk enforces strict type-safety through its Property system. Every incoming piece of data is validated against a schema before it ever reaches your controller.
...
- **Route Caching**: Features a high-performance cache to avoid scanning classes on every request in production. [Learn more](/cache/index)
- **Rate Limiting**: Includes a built-in system to protect endpoints from abuse. 
    ...
    - [Learn more about Rate Limiting](/routing/rate-limit)
...
- [Learn more about Security](/security/index)
