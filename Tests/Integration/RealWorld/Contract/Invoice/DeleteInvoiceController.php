...
class DeleteInvoiceController extends AbstractDeleteResourceController
{
    ...
    {
        return Route::delete('/v1/api/contracts/{contract_uuid}/invoices/{invoice_uuid}')
            ->pathProperty(
            ...
            ->routeAuthorization(new RouteAuthorization('bearer', ['api:contracts:invoices'], ['api:contracts:invoices:delete']));
    }
