...
class DocBlockResourceGeneratorTest extends TestCase
{
    ...
    public function testGeneratedDocBlockRendersExpectedAnnotations(): void
    {
        ...
        self::assertStringContainsString('@generated Auto generated by apivalk', $rendered);
        self::assertStringContainsString('@property string $animal_uuid', $rendered);
        self::assertStringContainsString('@property string $name', $rendered);
        self::assertStringContainsString('@property string $type', $rendered);
        self::assertStringContainsString('@property float|null $weight', $rendered);
    }
    ...
    public function testEmptyResourceProducesPlaceholder(): void
    {
        ...
        self::assertStringContainsString('(no properties)', $rendered);
    }
    ...
    public function testPropertyDescriptionIsAppendedToAnnotation(): void
    {
        ...
        self::assertStringContainsString('Unique identifier of the animal', $rendered);
        self::assertStringContainsString('Name of the animal', $rendered);
    }
}
